...
namespace rf
{
    ...
    enum AlpineControlConfigAction
    {
        ...
        AF_ACTION_RESET_CAMERA = 0x11,
        AF_ACTION_GYRO_MODIFIER_HOLD = 0x12,
        AF_ACTION_GYRO_MODIFIER_HOLD_INVERT = 0x13,
        AF_ACTION_GYRO_MODIFIER_TOGGLE = 0x14,
        _AF_ACTION_LAST_VARIANT = AF_ACTION_GYRO_MODIFIER_TOGGLE
    };
