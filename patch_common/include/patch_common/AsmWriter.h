...
public:
    ...
    template <>
    inline AsmWriter& push<int8_t>(int8_t imm)
    {
    ...
    template <>
    inline AsmWriter& push<uint8_t>(uint8_t imm)
    {
        return push<int8_t>(imm);
    }

    template <>
    inline AsmWriter& push<int32_t>(int32_t imm)
    {
        if (std::abs(imm) < 128)
    ...
    template <>
    inline AsmWriter& push<uint32_t>(uint32_t imm)
    {
